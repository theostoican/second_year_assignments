...
/**
 * <p>
 * A class that represents a cube node and it is used for a specific operation,
 * namely the calculation of the power of three of a specific number.
 * </p>
 * @author Theodor Stoican
 *
 */
public class CubeNode implements ASTNode, Visitable, MathNode{
