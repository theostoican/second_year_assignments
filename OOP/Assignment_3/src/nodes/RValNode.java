...
/**
 * <p>
 * A class that represents a right node(with respect to the assignment node).
 * It stores the value of a character.
 * </p>
 * @author Theodor Stoican
 *
 */
public class RValNode implements ASTNode, Visitable{
	 ...
	 */
	public RValNode(String character){
